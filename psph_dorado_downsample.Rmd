...
Dorado1 <- cbind(Dorado1[,c(1,3,6)], Dorado_t[,c(2)]/100) # The OriginalValue is modify fraction
...
Dorado_t = fread("/Users/lubeifang/Desktop/Benchmark/DATA/downS/37_6mA.bed", sep = " ", header = F)
Dorado2 <- cbind(Dorado2[,c(1,3,6)], Dorado_t[,c(2)]/100) # The OriginalValue is modify fraction
...
Dorado_t = fread("/Users/lubeifang/Desktop/Benchmark/DATA/downS/18_6mA.bed", sep = " ", header = F)
Dorado3 <- cbind(Dorado3[,c(1,3,6)], Dorado_t[,c(2)]/100) # The OriginalValue is modify fraction
...
Dorado_t = fread("/Users/lubeifang/Desktop/Benchmark/DATA/downS/9_6mA.bed", sep = " ", header = F)
Dorado4 <- cbind(Dorado4[,c(1,3,6)], Dorado_t[,c(2)]/100) # The OriginalValue is modify fraction
...
Dorado_t = fread("/Users/lubeifang/Desktop/Benchmark/DATA/downS/4_6mA.bed", sep = " ", header = F)
Dorado5 <- cbind(Dorado5[,c(1,3,6)], Dorado_t[,c(2)]/100) # The OriginalValue is modify fraction
...
Dorado_t = fread("/Users/lubeifang/Desktop/Benchmark/DATA/downS/2_6mA.bed", sep = " ", header = F)
Dorado6 <- cbind(Dorado6[,c(1,3,6)], Dorado_t[,c(2)]/100) # The OriginalValue is modify fraction
