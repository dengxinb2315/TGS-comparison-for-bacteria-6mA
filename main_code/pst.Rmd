...
DC3000_dorado_t = fread("/Users/lubeifang/Desktop/Benchmark/DATA/DC3000/DC3000WT_dorado.bed", sep = " ", header = F)
DC3000_dorado <- cbind(DC3000_dorado[,c(1,3,6)], DC3000_dorado_t[,c(2)]/100) # The OriginalValue is modify fraction
...
DC3000_dorado_WGA_t = fread("/Users/lubeifang/Desktop/Benchmark/DATA/DC3000/DC3000WGA_dorado.bed", sep = " ", header = F)
DC3000_dorado_WGA <- cbind(DC3000_dorado_WGA[,c(1,3,6)], DC3000_dorado_WGA_t[,c(2)]/100) # The OriginalValue is modify fraction
colnames(DC3000_dorado_WGA) <- c("Chromosome","Position","Strand","OriginalValue")
rm(DC3000_dorado_WGA_t)
