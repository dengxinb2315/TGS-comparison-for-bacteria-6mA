...
Dorado_MU_t = fread("/Users/lubeifang/Desktop/Benchmark/DATA/0104KO/dorado.bed", sep = " ", header = F)
Dorado_MU <- cbind(Dorado_MU[,c(1,3,6)], Dorado_MU_t[,c(2)]/100) # The OriginalValue is modify fraction
